...
* **cursor**: sono usati come varibili in stored proc oppure come parametri di OUTPUT sempre in stored proc, fanno riferimento ai [[Cursori in T-SQL|cursori]]. Possono essere nulli e non possono essere usati con le istruzioni CREATE TABLE.
...
* [[Comandi T-SQL comodi]]
* [[Trick Sql Server]]
* [[Query comode in T-SQL]]
